...
## (the followings work without API key)
...
## (the followings require API key - add your API key below)
## geocodefarm:  https://www.geocodefarm.com/
## mapquest:     http://www.mapquestapi.com/geocoding/
## opencage:     http://www.lokku.com (http://geocoder.opencagedata.com)

## NOT yahoo - because it's not free..
